...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/css/via.css')}}">
  </head>

  <body class="container-fluid " onload="_via_init()" onresize="_via_update_ui_components()">
    ...
    <!--
      ...
      -->
    <div class="row d-flex justify-content-between mt-3 p-4 ">

      <main class="col-8" style=" height: 80vh;">
        ...
        <ul>
          ...
          <li>Annotation
            <ul>
              ...
              <li onclick="download_as_image()" title="Download an image containing the annotations">Download Image</li>
            </ul>
          </li>
...
<li onclick="toggle_img_fn_list_visibility()" title="Show or hide a panel to update annotations corresponding to file and region">Toggle image filename list</li>
    ...
    <div class="middle_panel">
      ...
      <div id="leftsidebar" style="display:none">
        ...
        <button class="leftsidebar_accordion active">Draw</button>
        <div class="leftsidebar_accordion_panel show">
          <ul class="region_shape">
            ...
            <li id="region_shape_polygon" style="display:none" onclick="select_region_shape('polygon')" title="Polygon (Shortcut key 4)"><svg height="32" viewbox="0 0 32 32"><use xlink:href="#shape_polygon"></use></svg></li>
        ...
        <!-- Attributes -->
        <button style="display:none" class="leftsidebar_accordion" id="attributes_editor_panel_title">Attributes</button>
        ...
        <button class="leftsidebar_accordion" style="display:none">Keyboard Shortcuts</button>
      ...
      <div id="display_area" style="width:70vw">
        <div id="image_panel" class="display_area_content display_none paddingBox" >
